...
const ListingPhotos = (property: Property) => {
  ...
  return (
    <div className="flex gap-4 flex-col">
      <div className="relative w-[70vw] sm:w-full h-[40vh] sm:h-[60vh] rounded-md">
        {/* {JSON.stringify(property.imageGallery, null, 2)} */}
        <Image className='rounded'  alt="listing" fill src={urlForImage(propertyPhotos[currentPhoto]).url()}/>
      </div>
...
<Image className='rounded' src={urlForImage(photo).url()} alt="listing" fill/>
    </li>
  ))}
  </ul>
)}
